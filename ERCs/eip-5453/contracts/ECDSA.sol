...
library ECDSA {
    ...
    function tryRecover(bytes32 hash, bytes memory signature) internal view returns (address, RecoverError) {
        console.log("XXX solidity tryRecover");
        console.logBytes32(hash);
        console.logBytes(signature);
        console.log("XXX solidity signature.length");
        ...
        if (signature.length == 65) {
            ...
            console.log("XXX solidity r");
            console.logBytes32(r);
            console.log("XXX solidity s");
            console.logBytes32(s);
            console.log("XXX solidity v");
            console.logUint(v);
